    ...
    <div class="flex justify-center ">
        <div class="max-w-screen-lg w-full flex">
            ...
            <div
                ...
                <!-- Gambar -->
                <img src="../images/posts/image3.jpeg" class="w-full md:w-[500px] h-auto object-cover rounded-lg"
                    ...
                    <section x-data="{ expanded: false }" class="bg-white mt-0 py-8 lg:py-16 antialiased">
                                        ...
                                        <div x-data="{ open: false }" class="relative inline-block text-left ml-auto">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                <ul class="py-1 text-sm text-gray-700">
                                                    <li>
                                                        <button @click="expanded = !expanded" class=" text-start w-full">
                                                            <a href="#"
                        ...
                        <div class="mt-3 flex gap-4 items-center justify-end">
                            ...
                            <button class="flex items-center text-gray-600 hover:text-red-500 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-heart h-6 w-6"
                                    viewBox="0 0 16 16">
                                    <path
...
//model
 ...
 {{--   public function comments()
    ...
    diatas adalah model post

    // Relasi untuk mendapatkan user yang mengomentari
    public function user()
    {
     ...
     // Relasi untuk komentar utama (tanpa parent_id)
    public function parent()
    {
        return $this->belongsTo(Comment::class, 'parent_id');
    }

    // Relasi untuk reply (komentar yang memiliki parent_id)
            ...
            <a href="../pages/show.html" class="block">
                ...
                <div class="relative">
                    <img src="../images/posts/image1.jpeg"
                        class="w-full rounded-lg shadow-lg hover:opacity-80 transition duration-300" alt="Random Image" />
